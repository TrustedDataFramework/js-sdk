import { isZero, MemoryView, VirtualMachine, WasmInterface, VMInstance} from './vm'
import { concatBytes, encodeBE, padPrefix } from "./utils"
...
export abstract class AbstractHost {
    ...
    // before initialize
    setMem(memory: WebAssembly.Memory): void {
        this.view = new MemoryView(memory)
    }
